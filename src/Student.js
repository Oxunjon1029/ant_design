...
Tutors=()=>{
  axios.get(`http://213.230.99.101:2027/api/admin/students`).then(res=>
this.setState({
  tutordata:res
})
  )
  ...
  this.Tutors()
    ...
    toggle = () => {
     ...
     render() {
       ...
       const TutorGet=()=>{
        axios.post(`http://213.230.99.101:2027/api/admin/student/save`,{
       ...
       const DeleteTable=(id)=>{
         axios.delete(`http://213.230.99.101:2027/api/admin/student/delete/${id}`).then(res=>{
       ...
       const EditModal=()=>{
         ...
         axios.put(`http://213.230.99.101:2027/api/admin/student/edit/${this.state.id}`,{
       ...
       const Edit=(tutorId)=>{
         axios.get(`http://213.230.99.101:2027/api/admin/student/${tutorId}`).then(res=>{
